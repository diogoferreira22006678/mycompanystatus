...
<h1 class="text-uppercase text-primary">Ratios</h1>
        ...
        <div class="card shadow border-start-primary py-2">
            <div class="card-body">
                <div class="row align-items-center no-gutters">
                    <div class="col me-2">
                        <div class="text-uppercase text-primary fw-bold text-xs mb-1"><span>Liquidez Corrente</span></div>
                        <div class="text-dark fw-bold h5 mb-0"><span>€{{ $report->balance->capitalProprio->capitaisproprios_capitalrealizado}}</span></div>
                    </div>
        ...
        <div class="card-body">
            ...
            <div class="text-center small mt-4">
                <?php foreach ($dataPoints as $dataPoint): ?>
                    <span class="me-2">
                        <i class="fas fa-circle <?php echo $dataPoint['label'] === 'User' ? 'text-primary' : 'text-success'; ?>"></i>
                        &nbsp;<?php echo $dataPoint['label']; ?>
                    </span>
                <?php endforeach; ?>
            </div>                        
        </div>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        type: 'doughnut',
        data: {
            labels: dataPoints.map(function (dataPoint) {
            ...
            data: dataPoints.map(function (dataPoint) {
                return parseFloat(dataPoint.y).toFixed(2);
            }),
            }],
        },
        options: {
